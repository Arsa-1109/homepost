...
export default function LandlordPropertiesPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto animate-fade-slide-up">
      ...
      <form onSubmit={handleCreate} className="p-6 bg-[rgb(var(--ml-bg-secondary))] border border-border/50 rounded-2xl space-y-5 shadow-[0_4px_12px_rgba(0,0,0,0.03)]">
        <div>
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            {[1, 2].map((i) => (
              <div key={i} className="p-6 border border-border/50 rounded-2xl bg-[rgb(var(--ml-bg-secondary))] animate-pulse shadow-sm">
          ...
          >
            {properties.map(p => (
              <motion.div 
                ...
                key={p.id} 
                className="flex flex-col p-6 border border-border/50 rounded-2xl bg-[rgb(var(--ml-bg-secondary))] hover-lift transition-all duration-300 group shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-[rgb(var(--ml-accent))]/40"
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-[rgb(var(--ml-bg-primary))] rounded-xl border border-border/60 group-hover:border-[rgb(var(--ml-accent))]/30 group-hover:bg-[rgb(var(--ml-accent))]/10 transition-all duration-300 shadow-sm">
