...
export default function LandlordErrorBoundary({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Landlord subview error:", error);
  }, [error]);
    ...
    <div className="max-w-xl mx-auto my-12 p-8 rounded-3xl border border-red-500/20 bg-[rgb(var(--ml-bg-secondary))] text-center shadow-lg space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs sm:text-sm font-medium text-[rgb(var(--ml-text-secondary))] leading-relaxed">
          An unexpected issue occurred while rendering this landlord view. Your navigation and other tabs remain functional.
        </p>
      </div>
