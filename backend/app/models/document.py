...
class Document(SQLModel, table=True):
    ...
    unit_id: uuid.UUID | None = Field(default=None, foreign_key="units.id", index=True, nullable=True)
    uploaded_by: uuid.UUID = Field(foreign_key="users.id", index=True, nullable=False)
